...
public class MybatisPlusGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/tsl_yanshi?&serverTimezone=UTC";
    ...
    // 表名，多个表使用英文逗号分割
    private static final String TBL_NAMES = "BM_SS_MLXX,BM_SS_YWLM,BM_WD_MLXXX,MH_SS_BM,SS_MLXX20230807,WD_MLXXX20230807";
    // 表名的前缀，从表生成代码时会去掉前缀
